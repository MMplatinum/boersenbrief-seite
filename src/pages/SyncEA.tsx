...
const SyncEA = () => {
  React.useEffect(() => {
    document.title = 'SyncEA Expert Advisor - Trading Journal Synchronisation';
  ...
  const downloads = [
    {
      title: "SyncEA für MT4",
      description: "Expert Advisor für MetaTrader 4 - Automatische Synchronisation aller Trades mit dem Trading Journal (Version 1.01 vom 01.08.2025)",
    ...
    {
      title: "SyncEA für MT5", 
      description: "Expert Advisor für MetaTrader 5 - Automatische Synchronisation aller Trades mit dem Trading Journal (Version 1.01 vom 01.08.2025)",
    ...
    {
      title: "Installation & Setup Anleitung",
      description: "Schritt-für-Schritt Anleitung zur Installation und Konfiguration der SyncEA Expert Advisors",
      file: "/downloads/pdf/syncEA-anleitung-deutsch.pdf",
      icon: Settings,
      type: "PDF",
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 mb-8 tracking-tight leading-tight">
              Automatische Trade-Synchronisation
              <br />
              <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 bg-clip-text text-transparent">
                direkt aus MetaTrader
              </span>
            </h1>
            <p className="text-xl text-gray-600 font-light max-w-4xl mx-auto leading-relaxed">
              Keine manuelle Eingabe mehr - alle Trades werden automatisch ins Journal übertragen. Einfach installieren und die Daten automatisch eintragen lassen!
            </p>
          </motion.div>
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-4">
                Downloads für <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">MT4 & MT5</span>
              </h2>
              <p className="text-lg text-gray-600 font-light max-w-2xl mx-auto">
                Lade dir die passenden Expert Advisors für deine MetaTrader Version herunter
              </p>
            </div>
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-light text-gray-900 mb-4">
                So einfach <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">funktioniert's</span>
              </h2>
              <p className="text-lg text-gray-600 font-light">
                In wenigen Minuten von der Installation zur automatischen Synchronisation
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Lade den passenden Expert Advisor für deine MT4/MT5 Version herunter und installiere ihn"
                },
                {
                  step: "2", 
                  title: "Konfigurieren",
                  description: "Folge der Anleitung und konfiguriere den EA einmalig mit deinen Trading Journal Zugangsdaten"
                },
                {
                  step: "3",
                  title: "Automatisch synchronisieren",
                  description: "Ab sofort werden alle Trades automatisch mit deinem Trading Journal synchronisiert"
                }
              ].map((item, index) => (
          ...
          >
            ...
            <p className="text-lg text-gray-600 font-light mb-8 max-w-2xl mx-auto">
              Unser Support-Team hilft dir gerne bei der Einrichtung der SyncEA Expert Advisors. 
              Kontaktiere uns einfach über den Chat oder per E-Mail.
            </p>
            <a
