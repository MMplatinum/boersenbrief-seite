        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="text-xl text-gray-600 font-light max-w-4xl mx-auto leading-relaxed">
              Get our free Starter Guide now and learn step by step how to optimally set up and use your trading journal. From account setup through trade documentation to regular analysis of your results - this guide shows you the path to more structure, discipline and long-term success. Start today and download it right away!
            </p>
          </motion.div>
            ...
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-gray-900 mb-6 tracking-tight leading-tight">
                <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
                  Import Trades Without Headaches –
                </span>
                <br />
                Your Upload Guide
              </h2>
              <p className="text-xl text-gray-600 font-light max-w-4xl mx-auto leading-relaxed">
                Get our free Upload Guide now and learn step by step how to load "old" trade lists into the journal without errors. From the correct CSV format to perfect account assignment - this guide ensures that every trade is recognized and your performance is calculated precisely. Download the guide right away and start with a properly maintained journal in less than five minutes!
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-light">Clear instructions for the optimal start</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Error-Free Import</h4>
                    <p className="text-gray-600 font-light">CSV templates for perfect data quality</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Ready to Use Immediately</h4>
                    <p className="text-gray-600 font-light">Ready to go in just a few minutes</p>
                  </div>
                </div>
              </div>
            </div>
